jQuery(document).ready(function() {
    ...
    $.i18n().load({
        ...
        'fr': {
            ...
            'modal3-2': 'Ou scannez le QR code sur votre appareil mobile pour télécharger le skin plus rapidement.',
            ...
            'modal4-3': 'Cet outil vous offre également la possibilité de télécharger le skin affiché, de l’appliquer à Minecraft.net ou de l’appliquer à Minecraft Pocket Edition en le téléchargeant via un QR Code ou une adresse web.',
