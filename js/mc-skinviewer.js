...
function open() {
	...
	img.onload = function() {
		...
		$("#content").html('<iframe src="3d_engine/index.html?#' + skin + '" id="iframe" frameborder="0" allowtransparency="true"></iframe>');
	...
	if (skin != "") {
		...
		$.ajax({
			...
			success:function(v) {
				...
				$(".bitly").html('<table class="linktable"><tr><th><img src="https://chart.googleapis.com/chart?cht=qr&chl='+bit_url+'&chs=150x150&chld=L|0" /></th><th>'+bit_url+'</th></tr></table>');
			},
